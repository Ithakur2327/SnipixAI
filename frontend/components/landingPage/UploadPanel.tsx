...
interface Props {
  onGenerate: (text: string, type: string) => void;
}
              ...
              <>
                ...
                >
                  <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
                    <path
                      d="M5 3h8l4 4v10a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1z"
                      stroke="#E8590A"
                      strokeWidth="1.4"
                    />
        ...
        {activeInput === "URL" && (
          <div style={{ display: "flex", flexDirection: "column", gap: "8px" }}>
            <input
              ...
              onFocus={(e) =>
                (e.target.style.borderColor = "rgba(232,89,10,0.5)")
              }
              onBlur={(e) =>
            ...
            <p style={{ fontSize: "11px", color: "rgba(255,255,255,0.2)", paddingLeft: "4px" }}>
              Puppeteer will extract full page content automatically
            </p>
          </div>
        )}
