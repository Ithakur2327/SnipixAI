...
export default function Navbar() {
  ...
  // scroll detection and about-section tracking
  useEffect(() => {
    const updateState = () => {
  ...
  // hash detection — runs on mount (catches /#about on navigation) and on hash change
  useEffect(() => {
  ...
  // active link sync — purely derived from pathname + hash, no manual state needed
  useEffect(() => {
    ...
    <>
      ...
      <style>{`
        ...
        .snx-cta {
          ...
          background: #E8590A; color: #fff; font-size: 13px; font-weight: 600;
          border: none; cursor: pointer;
          font-family: var(--font-inter), sans-serif; outline: none; opacity: 0.82;
          transition: opacity 0.2s ease, transform 0.2s ease, box-shadow 0.2s ease;
        }
        .snx-cta:hover { opacity: 1; transform: translateY(-1px); box-shadow: 0 8px 24px rgba(232,89,10,0.38); }
        .snx-cta:active { transform: scale(0.97); opacity: 1; }
        ...
        .snx-avatar:hover { background: rgba(255,255,255,0.11); border-color: rgba(255,255,255,0.18); transform: translateY(-1px); }
        .snx-avatar:active { transform: scale(0.97); }

        .snx-avatar-icon {
          width: 28px; height: 28px; border-radius: 7px;
          background: linear-gradient(135deg, #E8590A 0%, #FF7A2F 100%);
        ...
        .snx-avatar-chevron {
          margin-left: 2px; color: rgba(255,255,255,0.35);
          transition: transform 0.2s ease, color 0.15s ease; flex-shrink: 0;
        }
        .snx-avatar:hover .snx-avatar-chevron { color: rgba(255,255,255,0.65); }
        ...
        .snx-drop-header { padding: 10px 10px 8px; border-bottom: 1px solid rgba(255,255,255,0.06); margin-bottom: 4px; }
        .snx-drop-item {
        ...
        .snx-drop-item.danger:hover { background: rgba(232,89,10,0.1); color: #E8590A; }
        ...
        @media (max-width: 980px) {
          ...
          .snx-avatar { padding: 6px 10px 6px 6px; }
            ...
            {isAuthenticated && user ? (
              <div style={{ position: "relative" }}>
                <button
                  ...
                  title={user.name}
                >
                  <span className="snx-avatar-icon">{initials}</span>
                    ...
                    <div className="snx-drop-header">
                      <div style={{ display: "flex", alignItems: "center", gap: "9px" }}>
                        <div style={{
                          ...
                          background: "linear-gradient(135deg, #E8590A, #FF7A2F)",
                        ...
                        <div style={{ marginLeft: "auto", flexShrink: 0, background: "rgba(232,89,10,0.12)", border: "1px solid rgba(232,89,10,0.22)", borderRadius: "6px", padding: "2px 7px" }}>
                          <span style={{ fontSize: "9.5px", color: "#E8590A", fontWeight: 700, textTransform: "uppercase", letterSpacing: "0.6px", fontFamily: "var(--font-inter), sans-serif" }}>
                            {user.plan}
                          </span>
                        </div>
                      </div>
